...
type Connection struct {
	...
	inMessages  Freelist // GUARDED_BY(mu)
	outMessages Freelist // GUARDED_BY(mu)
}
...
func (c *Connection) readMessage() (m *InMessage, err error) {
	// Allocate a message.
	m = c.getInMessage()
